...
impl Approx {
    ...
    pub fn default() -> Self {
        ...
        // let c2 = 0.685413182;
        // let c3 = 2.432130098;
        // let c1: u32 = 0x5f5e555c; // my best
        // let c2: f32 = 0.255280614;
        // let c3: f32 = 4.698304653;
        let c1: u32 = 0x5f1ffff9; // rr best
        let c2: f32 = 0.703952253;
        let c3: f32 = 2.38924456;
        let mut a = Approx {
            c1,
            c2,
            c3,
    ...
    */
    ...
    fn optimize_c2(&mut self) {
        ...
        loop {
            ...
            if r - l < 2f32 * f32::EPSILON || grad_mid == 0.0 {
                // FOUND IT! TODO: lower thresh?
                break;
            } else if grad_mid > 0.0 {
    ...
    fn _derror_dx(&mut self, x: f32) -> f32 {
        let x1 = x - 100.0 * f32::EPSILON;
        let x2 = x + 100.0 * f32::EPSILON;
...
impl Display for Approx {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(
            f,
            "rms_error={:e} y.u=0x{:x}-(y.u>>1); {:.9}*y.f*({:1.9}-x*y.f*y.f)",
            self.rms_error, self.c1, self.c2, self.c3
        )
    }
}
